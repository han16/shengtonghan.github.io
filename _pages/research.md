...
<p align="center">
    <img src="https://han16.github.io/shengtonghan.github.io/images/researchtheme.png?raw=true" 
         alt="Deep-MOTIFs workflow" style="width: 750px;">
</p>




We are interested in studying the disease pathology of autism, schizophrenia, cancers and dental diseases. By integrating multi-omics data including whole-exome, whole-genome, and epigenetic data, our work aims to develop innovative computational approaches and apply existing analytical tools to uncover new biological insights. 
...
<div style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 30px;">
  ...
  <div style="flex: 1; font-size: 1em;">
    <p>
      <b></b> <b>Han S<sup>+</sup>*</b>, Sun X<sup>+</sup>, Sloofman L<sup>+</sup>, Satterstrom FK, Xu X, Liang L, Knoblauch N, Sheng W, Zhao S, Nguyen TH, Wang G; Autism Sequencing Consortium; Buxbaum J, He X*.  
...
<div style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 30px;">
  ...
  <div style="flex: 1; font-size: 1em;">
    <p>
      <b> </b> Gousias, C., Alsuwaiyan, Z., Fial, A., <b>Han, S.</b>, Tatakis, D.N., and Kofina, V.*  
...
<div style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 30px;">
  ...
  <div style="flex: 1; font-size: 1em;">
    <p>
      <b></b> <b>Shengtong Han*</b>, Marieke Gilmartin, Wenhui Sheng, Victor X. Jin.  
...
<div style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 30px;">
 ...
 <div style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 30px;">
  ...
  <div style="flex: 1; font-size: 1em;">
    <p>
      <b>Jump-seq: genome-wide capture and amplification of 5hmC sites</b><br>
