...
<div style="margin-bottom: 30px;">
  ...
  <!-- Bottom Row: Full-width Foldable Abstract -->
  <details style="margin-top: 10px; width: 100%;">
    <summary style="cursor: pointer; color: #007bff; font-weight: bold; font-size: 0.9em; user-select: none;">
      [ Abstract ]
    </summary>
    <div style="margin-top: 8px; padding: 12px 16px; background-color: #f8f9fa; border-left: 3px solid #007bff; font-size: 0.9em; color: #333333; line-height: 1.5; width: 100%; box-sizing: border-box;">
